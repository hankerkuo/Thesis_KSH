'''	
	Annotation tool
		...
		Usage:
			...
			python annotation.py max_width max_height file1 ... fileN
...
'''
annotation format: x1,x2,x3,x4,y1,y2,y3,y4
coordinate system: 
	0----->x
	|
	|
...
from WPOD_src.utils import image_files_from_folder,getWH
from WPOD_src.label import Label, Shape, readShapes, writeShapes
from WPOD_src.projection_utils import perspective_transform, find_T_matrix, getRectPts
