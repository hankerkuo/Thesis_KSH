...
if __name__ == '__main__':
    ...
    if c.splice_train:
        real_training_dim = c.training_dim * 2
    else:
        real_training_dim = c.training_dim
    ...
    if c.load_weight:
        ...
        model.load_weights(c.transfer_weight)
    ...
    data_provider = DataProvider(c.training_data_folder, c.batch_size, c.training_dim, stride=c.stride,
                                 CCPD_origin=c.CCPD_origin, splice_train=c.splice_train, side=c.side,
