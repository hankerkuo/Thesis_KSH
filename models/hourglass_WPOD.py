...
def create_hourglass_network_WPOD(num_classes, num_stacks, num_channels, inres, outres, bottleneck):
...
def create_heads(prelayerfeatures, rf1, num_classes, hgid, num_channels):
    ...
    head_lpd_vertex = Conv2D(6, kernel_size=(3, 3), activation='linear', padding='same',
