class Configs:
    def __init__(self):
        ...
        self.saving_folder = '/home/shaoheng/Documents/Thesis_KSH/Link to training_result/reproduce'
        """Weight loading"""
        self.load_model_byh5 = True
        self.load_weight = False
        self.train_from_stratch = False
        self.iteration_to_load = 292000
        """Transfer learning"""
        ...
        """Benchmark configs"""
        self.info_saving_folder = '/home/shaoheng/Documents/Thesis_KSH/benchmark/mAP_weights/reproduce_dim512'  # MOST IMPORTANT
